...
and saves it to a local file named netflix_movies.csv in a folder named beaderstadt_data.
"""
...
fetched_folder_name = "beaderstadt_data"
...
def main():
    ...
    """
    csv_url = 'https://raw.githubusercontent.com/abeaderstadt/datafun-03-analytics/refs/heads/main/netflix_titles.csv'
    logger.info("Starting CSV fetch demonstration...")
    fetch_csv_file(fetched_folder_name, "netflix_movies.csv", csv_url)
