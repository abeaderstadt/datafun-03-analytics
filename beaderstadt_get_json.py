"""
This example file fetches JSON data of country names 
from the web and saves it to a local file named beaderstadt_data/countries.json
"""
...
def main():
    ...
    fetch_json_file(fetched_folder_name, "countries.json", json_url)
