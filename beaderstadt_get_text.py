"""
This example file fetches a text file of the Bee Movie script from the web 
and saves it to a local file named beemovie_script.txt in a folder named beaderstadt_data.
"""
